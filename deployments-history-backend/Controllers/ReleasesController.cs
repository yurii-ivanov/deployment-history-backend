...
using DeploymentsHistoryBackend.Services;
using Microsoft.AspNetCore.Mvc;

// For more information on enabling Web API for empty projects, visit https://go.microsoft.com/fwlink/?LinkID=397860

namespace DeploymentsHistoryBackend.Controllers
{
    ...
    public class ReleasesController : ControllerBase
    {
        ...
        public async Task<IEnumerable<Release>> GetByAppIdPaged(int appId, int page, int pageSize)
        {
            ...
            var app = await _applicationsRepository.GetById(appId);
            var deployments = await _deploymentsRepository.GetByAppIdPaged(appId, skip, take);
            var releases = new List<Release>();
